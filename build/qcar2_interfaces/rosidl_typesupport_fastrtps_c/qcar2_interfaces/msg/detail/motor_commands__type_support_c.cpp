...
bool cdr_serialize_qcar2_interfaces__msg__MotorCommands(
  const qcar2_interfaces__msg__MotorCommands * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_qcar2_interfaces
bool cdr_deserialize_qcar2_interfaces__msg__MotorCommands(
  eprosima::fastcdr::Cdr & cdr,
  qcar2_interfaces__msg__MotorCommands * ros_message)
{
  // Field name: motor_names
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_qcar2_interfaces
bool cdr_serialize_key_qcar2_interfaces__msg__MotorCommands(
  const qcar2_interfaces__msg__MotorCommands * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: motor_names
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_qcar2_interfaces
size_t get_serialized_size_key_qcar2_interfaces__msg__MotorCommands(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorCommands__ros_msg_type * ros_message = static_cast<const _MotorCommands__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_qcar2_interfaces
size_t max_serialized_size_key_qcar2_interfaces__msg__MotorCommands(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const qcar2_interfaces__msg__MotorCommands * ros_message = static_cast<const qcar2_interfaces__msg__MotorCommands *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_qcar2_interfaces__msg__MotorCommands(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  qcar2_interfaces__msg__MotorCommands * ros_message = static_cast<qcar2_interfaces__msg__MotorCommands *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_qcar2_interfaces__msg__MotorCommands(cdr, ros_message);
}
